...
<html lang="en">
    <head>
        ...
        <title>Bloquer un passager</title>
    ...
    <body class="sb-nav-fixed">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        ?>
                        <h1 class="mt-4">Bloquer un passager</h1>
                        <hr>
                        <?php
                            if ($nb==0) {
                            ?>
                        ...
                        <div class="col-xl-12 col-md-12">
                          ...
                          <div class="card bg-secondary text-white mb-4">
                            <div class="card-body">
                            <h6><i class="fa fa-arrow-circle-right" aria-hidden="true"></i>&nbsp;&nbsp;Sélectionner un passager à bloquer :</h6><br>
                              <form action="annuler_trajet.php" method="post">
                                ...
                                <select class="form-select" name="pass" aria-label="Default select example">
                                    <?php while($row=mysqli_fetch_array($req)){ ?>
                                        <option value="<?php echo $row['idP']; ?>"><?php echo $row['idP']." | ".$row['nomP']." ".$row['prenomP']; ?></option>
                                    <?php } ?>
                                </select>
        ...
        <?php
          if(isset($_POST['submit'])){
              ...
              $s = "DELETE FROM passager WHERE idP='$idpass'"; 
              $r = mysqli_query($conn,$s);
              if ($r){
                      ?>
                <script>
                var a = alert("Passager bloqué avec succès");
                window.location ="liste_passager.php";
                </script>
                <?php
              } else {
