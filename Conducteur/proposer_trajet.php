    ...
    <body class="sb-nav-fixed">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        ?>
                        <h1 class="mt-4">Créer un trajet</h1>
                        <hr>
        ...
        <?php
          if(isset($_POST['submit'])){
              ...
              $sql = "SELECT * FROM trajet WHERE date_depart='$date_dep' AND heure_depart='$heure_dep'";
              $req = mysqli_query($conn,$sql);
              ...
              if ($n > 0) {
                ...
                <?php
                  ...
                  $s = "INSERT INTO trajet(descT,statut,lieu_depart, date_depart, heure_depart, lieu_arrive, duree, nb_sieges, nb_places_dispo, prix, conditions, idConducteur) VALUES ('$desc',1,'$lieu_dep','$date_dep','$heure_dep','$lieu_arr','$duree','$nb_sieges','$nb_sieges','$prix_siege','$conds','$idCond')"; 
                  $r = mysqli_query($conn,$s);
                  if ($r){
                      ?>
                <script>
                var a = alert("Trajet ajouté avec succès");
                </script>
                <?php
